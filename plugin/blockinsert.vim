...
"       this is why there is text2 and <f-args> (<f-args>[0]?)
"
" todo: make the :commands accept a count as their first argument
" todo: see what happens when aborting (<esc> or ^c)
" todo: autoload...
" todo: documentation
function! blockinsert#do (operation, com, _count, text, text2) range
...
command! -nargs=* -range Both
            \ <line1>,<line2>call blockinsert#do ('i',  1, '', <f-args>)<bar>
            \ <line1>,<line2>call blockinsert#do ('a',  1, '', <f-args>)

command! -nargs=* -range QBoth
            \ <line1>,<line2>call blockinsert#do ('qi', 1, '', <f-args>)<bar>
            \ <line1>,<line2>call blockinsert#do ('qa', 1, '', <f-args>)

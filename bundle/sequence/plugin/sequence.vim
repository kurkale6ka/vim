...
xmap <silent> <plug>SequenceV_Increment
   \
   \ :call <sid>Sequence('v', 'seq_i')<cr>

xmap <silent> <plug>SequenceV_Decrement
   \
...
xmap <silent> <plug>SequenceAdd      :call <sid>Sequence('v', 'block_a')<cr>
xmap <silent> <plug>SequenceSubtract :call <sid>Sequence('v', 'block_x')<cr>
